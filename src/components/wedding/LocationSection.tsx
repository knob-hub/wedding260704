      ...
      duration: 0.8
        ...
        delay: 0.2
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <p className="font-medium text-foreground mb-1">더테라스 웨딩</p>
              <p className="text-sm text-muted-foreground">경기 고양시 일산동구 강석로 9 11층<br />
                5층 그랜드볼룸
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="tel:02-1234-5678" className="text-sm text-muted-foreground hover:text-primary transition-colors">031-905-1001</a>
          </div>
        </motion.div>
        ...
        delay: 0.4
          ...
          <button onClick={handleNaverMap} className="flex-1 py-3 px-4 rounded-lg bg-[#03C75A] text-white text-sm font-medium flex items-center justify-center gap-2 transition-transform hover:scale-[1.02]">
            <Navigation className="w-4 h-4" />
            네이버 지도
          </button>
          <button onClick={handleKakaoMap} className="flex-1 py-3 px-4 rounded-lg bg-[#FEE500] text-[#191919] text-sm font-medium flex items-center justify-center gap-2 transition-transform hover:scale-[1.02]">
            <Navigation className="w-4 h-4" />
            카카오맵
          </button>
        </motion.div>
          ...
          <div className="wedding-card">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">3호선 백석역 5,6번 출구에서 도보 5분</p>
              </div>
            </div>
          </div>
          ...
          <div className="wedding-card">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">건물 주차장 이용 (2시간 무료)</p>
              </div>
            </div>
          </div>
        </motion.div>
