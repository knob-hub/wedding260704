      ...
      >
        ...
        >
          <div className="flex items-center justify-center gap-2">
            <span className="text-muted-foreground">김철수 · 이영희</span>
            <span className="text-romantic">의 아들</span>
            <span className="font-medium text-foreground">민준</span>
          </div>
          <div className="flex items-center justify-center gap-2">
            <span className="text-muted-foreground">박민수 · 최지영</span>
            <span className="text-romantic">의 딸</span>
            <span className="font-medium text-foreground">서연</span>
          </div>
        </motion.div>
      </motion.div>
    </section>
